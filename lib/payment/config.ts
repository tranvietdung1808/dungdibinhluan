...
export const PRODUCTS: Record<ProductId, ProductConfig> = {
  'fc26-normal': {
    ...
    fulfillment: {
      kind: 'code',
      receiveText: 'Mã kích hoạt được gửi qua email sau khi thanh toán được xác nhận.',
      steps: [
  ...
  'mix-mods': {
    ...
    fulfillment: {
      kind: 'link',
      receiveText: 'Link tải được gửi qua email sau khi thanh toán được xác nhận. Sản phẩm này không dùng mã kích hoạt.',
      steps: [
        'Xác nhận thanh toán qua PayOS',
