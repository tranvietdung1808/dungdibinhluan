...
function supportSection() {
  return `
    <div style="background:#1a2420;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin:0 0 24px">
      <p style="color:#6ef2a0;font-size:12px;font-weight:bold;margin:0 0 10px;text-transform:uppercase;letter-spacing:1px">Thông tin hỗ trợ</p>
      <p style="margin:0 0 8px;font-size:11px;color:#aaa;line-height:1.6">
        Mọi vấn đề vui lòng liên hệ <a href="https://web.facebook.com/dungbinhluan/" style="color:#6ef2a0;text-decoration:none">fanpage hỗ trợ</a>
      </p>
...
function downloadSection(productName: string, downloadUrl: string) {
  return `
    <div style="background:#111;border:1px solid #333;border-radius:12px;padding:20px;margin:0 0 24px;text-align:center">
      <p style="color:#888;font-size:11px;margin:0 0 6px;text-transform:uppercase;letter-spacing:1px">Sản phẩm</p>
      <p style="font-size:16px;font-weight:bold;margin:0 0 16px">${productName}</p>
      <p style="color:#6ef2a0;font-size:13px;font-weight:bold;margin:0 0 8px;text-transform:uppercase;letter-spacing:1px">Link tải</p>
      <a href="${downloadUrl}" style="display:inline-block;padding:12px 24px;background:#6ef2a0;color:#fff;text-decoration:none;border-radius:10px;font-size:13px;font-weight:bold;letter-spacing:1px;margin:0 0 4px">TẢI NGAY</a>
...
function stepsSection(codeEntryUrl: string, hasCode: boolean, codeLabel: string) {
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
          ...
          <tr>
            <td style="vertical-align:top;padding:0 10px 14px 0">
              <span style="display:inline-block;width:24px;height:24px;line-height:24px;text-align:center;background:rgba(110,242,160,0.1);color:#6ef2a0;border-radius:50%;font-size:12px;font-weight:bold;border:1px solid rgba(110,242,160,0.2)">2</span>
            </td>
            <td style="vertical-align:top;padding:0 0 14px 0">
  ...
  return `
    <div style="background:#111;border:1px solid #333;border-radius:12px;padding:20px;margin:0 0 24px">
      <p style="color:#6ef2a0;font-size:13px;font-weight:bold;margin:0 0 14px;text-transform:uppercase;letter-spacing:1px">Các bước tiếp theo</p>
      <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td style="vertical-align:top;padding:0 10px 14px 0;width:24px">
            <span style="display:inline-block;width:24px;height:24px;line-height:24px;text-align:center;background:rgba(110,242,160,0.1);color:#6ef2a0;border-radius:50%;font-size:12px;font-weight:bold;border:1px solid rgba(110,242,160,0.2)">1</span>
    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <body style="margin:0;padding:0;background:#000;">
          <div style="max-width:500px;margin:0 auto;font-family:Arial,sans-serif;background:#0a0e0c;color:#fff;border-radius:16px;padding:32px;border:1px solid #222;">
