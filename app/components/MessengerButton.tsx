  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[9999] flex flex-col items-end">
      ...
      >
        ...
        <div className="p-4 bg-white dark:bg-[#0a0a0a] border-t border-black/5 dark:border-white/5">
          <button 
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 bg-[var(--color-primary)] hover:bg-[#b44c5c] active:scale-[0.98] text-white font-semibold rounded-xl transition-all text-sm shadow-md"
          >
      ...
      <button
        ...
        className="flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[var(--color-primary)] hover:bg-[#b44c5c] text-white rounded-full shadow-[0_4px_20px_rgba(206,90,103,0.4)] transition-all duration-300 hover:scale-110 active:scale-95 z-10"
