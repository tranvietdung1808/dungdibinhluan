                    ...
                    <div className="bg-[#0f0a0c] backdrop-blur-3xl rounded-[2.9rem] p-12 text-center">
                        <div className="flex justify-between items-center mb-12">
                            <div className="text-left">
                                ...
                                <p className="text-[10px] text-slate-500 tracking-[0.4em] uppercase mt-1">ALL IN ONE GAME SET UP</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-12">
                            <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                                ...
                                <p className="text-2xl font-black">50<span className="text-sm text-[#ce5a67]">GB</span></p>
                            </div>
                            <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
